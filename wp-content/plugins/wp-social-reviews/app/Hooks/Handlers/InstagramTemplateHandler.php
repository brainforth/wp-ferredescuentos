...
class InstagramTemplateHandler
{
    ...
    public function renderPostMedia($feed = [], $template_meta = [], $index = null, $display_optimize_image = null)
    {
        ...
        $app->view->render('public.feeds-templates.instagram.elements.media', [
            ...
            'placeholder_img_class' => (($media_url && !str_contains($media_url, 'placeholder')) || $oembed_image_failed ? 'wpsr-show' : 'wpsr-hide'),
            'animation_img_class' => ($media_url && (str_contains($media_url, 'placeholder') && !$oembed_image_failed) || $layout_type === 'carousel') ? 'wpsr-animated-background' : '',
            'index'         => $index,
