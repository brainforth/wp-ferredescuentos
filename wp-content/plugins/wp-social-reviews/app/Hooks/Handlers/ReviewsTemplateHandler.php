...
class ReviewsTemplateHandler
{
     ...
     *
     **/
    public function renderReviewerNameHtml($display_reviewer_name = 'true', $reviewer_url = '', $reviewer_name = '', $enableExternalLink = 'true', $platformName = 'google', $enableVerifiedBadge = 'false')
    {
