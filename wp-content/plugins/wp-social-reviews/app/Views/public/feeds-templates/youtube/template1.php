...
if (!empty($feeds) && is_array($feeds)) {
    ...
    foreach ($feeds as $index => $feed) {
        if ($index >= $sinceId && $index <= $maxId) {
            ...
            <div tabindex="0" role="group" class="wpsr-yt-video <?php echo ($layout_type === 'carousel' && defined('WPSOCIALREVIEWS_PRO')) ? 'swiper-slide' : ''; ?>">
                <?php
                /**
                 ...
                 **/
                do_action('wpsocialreviews/youtube_feed_preview_image', $feed, $template_meta, $index, $templateId, $feed_info);
                ?>
